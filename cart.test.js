...
describe('Cart Properties', ()=> {
    ...
    test('Total of cart should be 0', ()=> {
...
describe(' Cart Methods', ()=>{
    ...
    test('addToCart() should add a car to to the array', ()=>{
    ...
    test('addToCart() should add to the total', ()=>{
        cart.addToCart(cars[0] );
        cart.addToCart(cars [7] );
        cart.addToCart(cars[4]);

        expect(cart.total ).toEqual( cars[0].price + cars[7].price + cars[2].price);
    })
